...
#define BINARY_FILE_URL "https://ota.esp32.eu.org/hello-world.bin"

// https://github.com/espressif/esp-idf/blob/6517c5033aab27afe491e433d6beeba93dfb1aa7/examples/protocols/esp_http_client/main/howsmyssl_com_root_cert.pem

extern const char ssl_root_cert_pem_start[] asm("_binary_ssl_root_cert_pem_start");
extern const char ssl_root_cert_pem_end[]   asm("_binary_ssl_root_cert_pem_end");
...
void http_client(void* data) 
{
	...
	esp_http_client_config_t config = {
        ...
        .cert_pem = ssl_root_cert_pem_start
    };
	...
	ESP_LOGW(TAG , "stack watermark: %d", uxTaskGetStackHighWaterMark(NULL));
